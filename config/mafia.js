...
var commands = exports.commands = {
	...
	mstart: function(target, room, user, connection) {
		...
		if (mafia.gameRunning) {
			return this.sendReply('A game is currently being played. Use /mjoin to join the next game.');
		}
		if (mafia.gameStarting) {
			return this.sendReply('A game is currently in its sign-up phase. Use /mjoin to join.');
		}
